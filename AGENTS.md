...
Chat-with-Bluey is a mobile-friendly AI companion app for elderly users (60+) that answers daily questions, sets medication/water/toilet reminders, and offers light physical and mental games — free for 5 questions/day with a paid subscription for unlimited use.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "204312630+SkyaAI@users.noreply.github.com"
  git config user.name "SkyaAI"
  ```
